...
Use GoFr's documented Swagger/OpenAPI generation and route annotations. Keep generated transport documentation at the adapter boundary; model application/domain contracts independently. Verify the generated spec and GoFr route behavior together.

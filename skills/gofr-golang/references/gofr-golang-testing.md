...
## GoFr testing adaptation

Separate pure domain/application unit tests from GoFr adapter tests and datasource integration tests. Use GoFr's documented mock container/context facilities for framework and datasource behavior, and mock application ports rather than GoFr internals in use-case unit tests. Test binding, route registration, error mapping, health, configuration, and lifecycle at the GoFr boundary.

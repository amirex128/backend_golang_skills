...
Treat `*gofr.Context`, datasource handles, publisher/subscriber clients, cron jobs, startup hooks, and shutdown as owned resources. Use GoFr's lifecycle and health facilities, never hide panics or leak goroutines, and check all `Bind`, datasource, and downstream errors.

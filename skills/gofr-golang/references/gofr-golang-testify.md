...
Use GoFr's testing helpers and documented test context/datasource setup for adapter and integration tests. Mock application ports rather than GoFr internals for unit tests; use GoFr HTTP tests to verify binding, response mapping, middleware, health, and framework error behavior.

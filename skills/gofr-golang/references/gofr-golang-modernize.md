# GoFr-Golang: Modernize

## GoFr integration overlay

Before modernization, inspect the project's pinned GoFr version, Go version, module dependencies, and the current official GoFr source/index. Verify deprecated GoFr APIs against the installed module and official docs; update GoFr and Go toolchain together only with tests and a recorded compatibility decision.

# Modernize

This reference consolidates all retained guidance from `golang-modernize`. Read it for the matching Go engineering task.
...
## Source Reference: `golang-modernize/references/tooling.md`
...
## Source Reference: `golang-modernize/references/versions.md`

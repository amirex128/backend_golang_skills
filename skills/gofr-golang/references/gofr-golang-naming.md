...
Use GoFr's public names exactly as documented (`gofr.Context`, `gofr.New`, datasource and handler APIs). Keep framework names at adapters/infrastructure and use domain language inside aggregates and application use cases. Avoid leaking framework names into domain concepts.

...
Refactor toward Clean Architecture without breaking GoFr route contracts, lifecycle, configuration, health, observability, or datasource behavior. Move logic behind application handlers incrementally; keep GoFr handlers as compatibility adapters and validate with GoFr HTTP tests plus architecture tests.

...
The GoFr skill is mandatory for Go 1.27 backend work in a project that uses this repository. It covers the official quick start, advanced features, production guides, datasources, references, comparisons, migrations, and AI-assistant conventions. Start at [`skills/gofr/SKILL.md`](skills/gofr/SKILL.md); use [`skills/manifest.json`](skills/manifest.json) to locate the exact page reference for a feature.
